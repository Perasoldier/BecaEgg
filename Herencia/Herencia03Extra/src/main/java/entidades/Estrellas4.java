 ...
 * agregado por las limosinas: • $15 por la cantidad de limosinas del hotel. 17
...
public class Estrellas4 extends Hotel {
    ...
    protected EnumGimnasio tipo;
    protected String NombreRestaurante;
    protected int capRestaurante, precioHabitacion4;

    public Estrellas4() {
    }

    public Estrellas4(EnumGimnasio tipo, String NombreRestaurante, int capRestaurante, int cantHanitaciones, int nCamas, int nPisos, String nombre, String direccion, String localidad, String gerente) {
    ...
    public Estrellas4(EnumGimnasio tipo, String NombreRestaurante, int capRestaurante, int precioHabitacion4, int cantHanitaciones, int nCamas, int nPisos, String nombre, String direccion, String localidad, String gerente) {
        super(cantHanitaciones, nCamas, nPisos, nombre, direccion, localidad, gerente);
        this.tipo = tipo;
        this.NombreRestaurante = NombreRestaurante;
        this.capRestaurante = capRestaurante;
        this.precioHabitacion4 = precioHabitacion4;
    }
