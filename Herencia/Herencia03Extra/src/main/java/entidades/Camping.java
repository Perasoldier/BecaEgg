...
/**
 * *3. Una compañía de promociones turísticas desea mantener información sobre
 * la infraestructura de alojamiento para turistas, de forma tal que los
 * clientes puedan planear sus vacaciones de acuerdo con sus posibilidades. Los
...
public class Camping extends ExtraHotelero {
    ...
    private int carpas, banio;
    private boolean restaurante;

    public Camping() {
    }

    public Camping(int carpas, int banio, boolean restaurante, boolean privado, int metraje, String nombre, String direccion, String localidad, String gerente) {
